<?php $__env->startSection('content'); ?>
    ...
    <form class="form_master" method="post" action="<?php echo e(route('register.perform')); ?>">
        ...
        <div class="form_question">
            ...
            <input type="password" class="form-control" name="conferma_password" value="<?php echo e(old('conferma_password')); ?>" placeholder="Conferma Password" required="required">

            <label for="floatingConfirmPassword">Conferma Password</label>

            <?php if($errors->has('conferma_password')): ?>

                <span class="form_error"><?php echo e($errors->first('conferma_password')); ?></span>
